        ...
        >
          ...
          >
            {stats.map(({ key, value, icon: Icon }) => (
              <div key={key} className="leather-card rounded-xl p-4 flex flex-col items-center text-center group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-muted-foreground text-xs font-display tracking-wide uppercase">{t(key, lang)}</div>
              </div>
            ))}
          </motion.div>
        </motion.div>
