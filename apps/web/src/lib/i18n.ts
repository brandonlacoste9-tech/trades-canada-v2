...
const translations = {
  en: {
    ...
    "features.seo.title": "Bilingual Lead Network",
    "features.seo.desc": "Target homeowners in your city in both English and French with our optimized lead capture engine.",
    "features.leads.title": "Nationwide Lead Targeting",
    "features.leads.desc": "Homeowner form leads from major Canadian markets — name, phone, and job type.",
    "features.automation.title": "Follow-up Automation",
    ...
    "features.radar.desc": "Track new leads and municipal permits across provinces in one dashboard.",
    "features.intel.title": "Building Permits",
    "features.intel.desc": "New permit jobs from Toronto, Vancouver, Calgary, Montreal & more.",
    ...
    "pricing.starter.name": "The Lead Starter",
    ...
    "marketplace.stats.leadsInNetwork": "Leads in network",
    "marketplace.stats.avgLeadScore": "Avg. lead score",
    ...
    "marketplace.roofing": "Roofing",
    "marketplace.landscaping": "Landscaping",
    "marketplace.renovations": "Renovations",
    "marketplace.general": "General Construction",
    ...
    "settings.telegram.instructions": "Enter your Bot Token from @BotFather, or connect to our central bot using the verification code below:",
    "settings.telegram.waiting": "Waiting for connection...",
    "settings.telegram.setup.title": "How to Setup Telegram Alerts",
    "settings.telegram.setup.step1": "1. Find @BotFather on Telegram and send /newbot",
    "settings.telegram.setup.step2": "2. Follow instructions to name your bot and get the API Token",
    "settings.telegram.setup.step3": "3. Paste your API Token below and click Save",
    "settings.telegram.setup.step4": "4. Send anything to your new bot to start receiving leads",
    "settings.telegram.useCentral": "Alternatively, use our central bot @TradesCanadaBot with code:",
    "settings.telegram.tokenPlaceholder": "Your Telegram Bot Token",
    ...
    // Marketplace Intel
    "marketplace.intel.view": "View details",
    "marketplace.intel.title": "Lead details",
    "marketplace.intel.summary": "Project summary",
    "marketplace.intel.location": "Location",
    "marketplace.intel.scope": "Trade / scope",
    "marketplace.intel.value": "Est. job value",
    "marketplace.intel.velocity": "Urgency",
    "marketplace.intel.warning": "Contact and full details unlock when you claim this lead.",
    "marketplace.intel.cta": "Claim this lead",
  },
  fr: {
    // Nav
    ...
    "features.seo.title": "Réseau de leads bilingue",
    "features.seo.desc": "Ciblez les propriétaires de votre ville en anglais et en français avec notre moteur de capture de leads optimisé.",
    "features.leads.title": "Ciblage national de leads",
    "features.leads.desc": "Leads propriétaires des grands marchés canadiens — nom, téléphone et type de travaux.",
    ...
    "features.radar.desc": "Suivez les nouveaux leads et permis municipaux dans toutes les provinces.",
    "features.intel.title": "Permis de construction",
    "features.intel.desc": "Nouveaux jobs de permis à Toronto, Vancouver, Calgary, Montréal et plus.",
    ...
    "marketplace.stats.leadsInNetwork": "Leads dans le réseau",
    "marketplace.stats.avgLeadScore": "Score lead moyen",
    ...
    "marketplace.roofing": "Toiture",
    "marketplace.landscaping": "Aménagement paysager",
    "marketplace.renovations": "Rénovations",
    "marketplace.general": "Construction générale",
    ...
    "settings.telegram.instructions": "Entrez le jeton (token) de votre bot via @BotFather, ou connectez-vous à notre bot central avec le code de vérification ci-dessous :",
    "settings.telegram.waiting": "En attente de connexion...",
    "settings.telegram.setup.title": "Comment configurer les alertes Telegram",
    "settings.telegram.setup.step1": "1. Trouvez @BotFather sur Telegram et envoyez /newbot",
    "settings.telegram.setup.step2": "2. Suivez les instructions pour nommer votre bot et obtenir le Token API",
    "settings.telegram.setup.step3": "3. Collez votre Token API ci-dessous et cliquez sur Sauvegarder",
    "settings.telegram.setup.step4": "4. Envoyez n'importe quel message à votre nouveau bot pour recevoir les leads",
    "settings.telegram.useCentral": "Alternativement, utilisez notre bot central @TradesCanadaBot avec le code :",
    "settings.telegram.tokenPlaceholder": "Votre Token API Telegram",
    ...
    // Marketplace Intel
    "marketplace.intel.view": "Voir les détails",
    "marketplace.intel.title": "Détails du lead",
    "marketplace.intel.summary": "Sommaire du projet",
    "marketplace.intel.location": "Emplacement",
    "marketplace.intel.scope": "Métier / portée",
    "marketplace.intel.value": "Valeur estimée",
    "marketplace.intel.velocity": "Urgence",
    "marketplace.intel.warning": "Les coordonnées se débloquent lorsque vous réclamez ce lead.",
    "marketplace.intel.cta": "Réclamer ce lead",
  },
} as const;
